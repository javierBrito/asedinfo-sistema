...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-08-2023 a las 17:36:56
...
INSERT INTO `cat_producto` (`codigo`, `cod_marca`, `cod_unidad`, `descripcion`, `precio_compra`, `precio_costo`, `precio_mayoreo`, `precio_minoreo`, `aplica_iva`, `num_existencia_actual`, `num_existencia_minima`, `imagen`, `nombre_imagen`, `path_imagen`, `estado`, `fecha_registra`) VALUES
(1, NULL, NULL, 'NETFLIX', 0, 10.25, 0, 0, 0, 12, 0, NULL, NULL, NULL, 'A', '2023-08-23'),
(2, NULL, NULL, 'ESET', 0, 9.95, 0, 0, 0, 5, 0, NULL, NULL, NULL, 'A', '2023-08-24');
...
--
-- Estructura de tabla para la tabla `ven_transaccion`
--

CREATE TABLE `ven_transaccion` (
  `codigo` int(11) NOT NULL,
  `cod_cliente` int(6) NOT NULL,
  `cod_producto` int(6) NOT NULL,
  `descripcion` varchar(125) NOT NULL,
  `precio_venta` float NOT NULL,
  `precio_promocion` float DEFAULT NULL,
  `num_producto_venta` int(4) NOT NULL,
...
--
-- Volcado de datos para la tabla `ven_transaccion`
--

INSERT INTO `ven_transaccion` (`codigo`, `cod_cliente`, `cod_producto`, `descripcion`, `precio_venta`, `precio_promocion`, `num_producto_venta`, `num_producto_adicional`, `monto_venta`, `monto_descuento`, `aplica_iva`, `estado`, `fecha_inicio`, `fecha_fin`, `fecha_caduca`, `fecha_registra`, `num_mes`) VALUES
(1, 2, 1, 'TRANSACCION PRUEBA', 5, NULL, 1, NULL, NULL, NULL, 0, 'A', '2023-08-24', '2023-08-24', NULL, '2023-08-24', 0),
(2, 2, 1, 'TRANSACC PROMO', 6, NULL, 4, NULL, NULL, NULL, 0, 'A', '2023-08-25', '2023-08-26', NULL, '2023-08-25', 0),
(3, 1, 2, 'TRANSACCION JB', 4.55, NULL, 4, NULL, NULL, NULL, 0, 'A', '2023-08-25', '2023-09-25', NULL, '2023-08-25', 0),
(4, 1, 1, 'TRANSACCION NUEVA', 1.9, NULL, 5, NULL, NULL, NULL, 0, 'A', '2023-08-25', '2023-08-25', NULL, '2023-08-25', 0),
(5, 1, 2, 'TRANSACCION JB NUEVA', 2.5, NULL, 3, NULL, NULL, NULL, 0, 'A', '2023-08-25', '2023-12-25', NULL, '2023-08-25', 0),
(6, 1, 1, 'TRANSACC PROMO', 4.5, NULL, 3, NULL, NULL, NULL, 0, 'A', '2023-08-25', '2023-12-25', NULL, '2023-08-25', 0),
(7, 1, 1, 'TRANSACCION JB', 5.4, NULL, 5, NULL, NULL, NULL, 0, 'A', '2023-08-26', '2023-12-26', NULL, '2023-08-26', 0),
(8, 1, 1, 'TRANSACCION JB', 5.4, NULL, 6, NULL, NULL, NULL, 0, 'A', '2023-08-26', '2023-12-26', NULL, '2023-08-26', 4);
...
--
-- Indices de la tabla `ven_transaccion`
--
ALTER TABLE `ven_transaccion`
  ADD PRIMARY KEY (`codigo`);
...
--
-- AUTO_INCREMENT de la tabla `ven_transaccion`
--
ALTER TABLE `ven_transaccion`
