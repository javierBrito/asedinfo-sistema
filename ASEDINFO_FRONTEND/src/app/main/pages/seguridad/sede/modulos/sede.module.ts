...
import { RUTA_SEDE } from '../rutas/sede-routing';
import { SedePrincipalComponent } from '../componentes/sede-principal/sede-principal.component';
import { FormSedeComponent } from '../componentes/sede-principal/form-sede/form-sede.component';
import { DetailComponent } from '../componentes/detail/detail.component';

@NgModule({
  declarations: [
    SedePrincipalComponent,
    FormSedeComponent,
    DetailComponent
  ],
  imports: [
    CommonModule,
    RouterModule.forChild(RUTA_SEDE),
    CoreCommonModule,
    ContentHeaderModule,
    NgxPaginationModule,
    MaterialModule,
