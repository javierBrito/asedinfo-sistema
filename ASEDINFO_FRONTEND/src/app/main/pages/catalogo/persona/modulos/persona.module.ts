...
import { RUTA_PERSONA } from '../rutas/persona-routing';
import { FormPersonaComponent } from '../componentes/persona-principal/form-persona/form-persona.component';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    RouterModule.forChild(RUTA_PERSONA),
    CoreCommonModule,
    ContentHeaderModule,
    NgxPaginationModule,
    MaterialModule,
